...
const AIAssistPanel: React.FC<AIAssistPanelProps> = ({ item, debugMode: _debugMode }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Debug Mode */}
      {_debugMode && state.data && (
        <div className="bg-gray-900 border border-gray-700 rounded-lg p-3">
          <p className="text-xs font-mono text-gray-300 mb-2">Debug: Raw AI Response</p>
          <pre className="text-xs text-gray-400 overflow-auto max-h-48">
            {JSON.stringify(state.data, null, 2)}
          </pre>
          {state.error && (
            <>
              <p className="text-xs font-mono text-red-400 mt-2 mb-2">Validation Errors</p>
