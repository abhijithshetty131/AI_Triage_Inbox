...
export function validateAIResponse(data) {
    ...
    return {
        ...
        errors: [],
        data: {
            summary_bullets: obj.summary_bullets,
...
function generateMockAI(item) {
    ...
    let category = categoryOptions[hash % categoryOptions.length];
...
export async function generateAIResponse(item, options) {
...
export function clearAICache(itemId) {
    if (itemId) {
